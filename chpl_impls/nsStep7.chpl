...
if createPlots then printAndPlot(u, (xLen, yLen), "results/nsStep7_ics", "ICs", "density");
...
if createPlots then printAndPlot(u, (xLen, yLen), "results/nsStep7_sol", "Sol", "density");
