...
do
    /usr/bin/time -a -o ./dat/times_7_cpp.txt ./cpp_impls/release/nsStep7 $args7 > /dev/null
    /usr/bin/time -a -o ./dat/times_7_chpl.txt ./chpl_impls/release/nsStep7 $args7 > /dev/null
done
...
do
    /usr/bin/time -a -o ./dat/times_89_cpp.txt ./cpp_impls/release/nsStep89 $args89 > /dev/null
    /usr/bin/time -a -o ./dat/times_89_chpl.txt ./chpl_impls/release/nsStep89 $args89 > /dev/null
done
